...
4. Sau khi nhận được kết quả (Observation) từ Tool, nếu yêu cầu còn bước phụ thuộc dữ liệu vừa nhận thì gọi Tool tiếp theo; nếu đã hoàn tất thì trả lời rõ ràng, chính xác cho sinh viên.
